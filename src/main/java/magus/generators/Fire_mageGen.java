...
public class Fire_mageGen extends CharacterGenerator implements CharacterGen {
    ...
    public Fire_mageGen(Character character) {
        super(character);
    }
    ...
    @Override
    public int painResistancePontForXP() { return 30; }
